...
def album_from_google(album_name):
    import gapp
    gapp.init('client_secret.json',
...
if __name__ == '__main__':        # Run from command line
    ...
    parser.add_argument("--location_path", '-l',
                        ...
                        help='path to your Location history '
